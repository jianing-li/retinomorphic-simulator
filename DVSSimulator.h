...
public:
	long long int D_event;
	DVSSimulator(int _width = 400, int _height = 250, int _channels = 1, int _Dt = 50):
	width(_width), height(_height), channels(_channels), DVSthres(_Dt)
	{
